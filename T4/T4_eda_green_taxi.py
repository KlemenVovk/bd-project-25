...
print("Loading cleaned green taxi data...")
dataset_path = os.path.join(TASK2_OUT_ROOT, "green_tripdata")
...
json_path = os.path.join(RESULTS_ROOT, "green_tripdata_aggregates.json")
